...
use testPG;
show tables;
insert into mt22i04001_menu(valor) value
("inicio"),
("admision"),
("directorio"),
("facultades"),
...
select * from mt22i04001_visionmision;
insert into mt22i04001_visionmision (tema, descripcion) value
...
select * from mt22i04001_facultad;
insert into mt22i04001_facultad (nombre) value
("F. Ciencias Juridicas"),
("F. de Economia"),
("F. de  Ingenieria");

select * from mt22i04001_programa;
insert into mt22i04001_programa (nombre, facultad_id) value
